...
4) Leave one out, LOO (_Leave one out at a time (LOO) pipeline_17032024.docx_) - located in **16S** folder (note that there is a demo folder to better visualise the process)
5) Source variability, i.e., assessing source library based on number of included source samples (_Source variability pipeline_30102024.docx_) - located in **16S** folder (note that there is a demo folder to better visualise the process)
